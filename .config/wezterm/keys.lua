...
return {
  ...
  { key = "&", mods = "SUPER", action = wezterm.action.ActivateTab(0) },
  { key = "é", mods = "SUPER", action = wezterm.action.ActivateTab(1) },
  { key = '"', mods = "SUPER", action = wezterm.action.ActivateTab(2) },
  { key = "'", mods = "SUPER", action = wezterm.action.ActivateTab(3) },
  { key = "(", mods = "SUPER", action = wezterm.action.ActivateTab(4) },
  { key = "§", mods = "SUPER", action = wezterm.action.ActivateTab(5) },
  { key = "è", mods = "SUPER", action = wezterm.action.ActivateTab(6) },
  { key = "è", mods = "SUPER", action = wezterm.action.ActivateTab(7) },
  { key = "è", mods = "SUPER", action = wezterm.action.ActivateTab(8) },
  { key = "ç", mods = "SUPER", action = wezterm.action.ActivateTab(9) },
  { key = "0", mods = "SUPER", action = wezterm.action.ActivateTab(10) },
