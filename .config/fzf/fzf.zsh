...
export FZF_PROMPT_FILE='File > '
export FZF_PROMPT_FILE_HIDDEN='File [h] > '
export FZF_PROMPT_FILE_IGNORE='File [i] > '
export FZF_PROMPT_FILE_ALL='File [i][h] > '
export FZF_PROMPT_DIR='Directory > '
export FZF_PROMPT_DIR_HIDDEN='Directory [h] > '
export FZF_PROMPT_DIR_IGNORE='Directory [i] > '
export FZF_PROMPT_DIR_ALL='Directory [i][h] > '
export FZF_PROMPT_COMMAND='Command > '
export FZF_PROMPT_ALIAS='Alias > '
export FZF_PROMPT_COMMIT='Commit > '
