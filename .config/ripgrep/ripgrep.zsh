...
# Show the alias definition for the single alias corresponding to the provided string
function rg_alias() {
    rg --no-filename --no-line-number --type zsh "^alias $1=" ~/.config/
}
# Show the alias definitions for all aliases starting with the provided string
